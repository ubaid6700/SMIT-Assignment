...
var workingfoodmenu = document.querySelectorAll('.workingfoodmenu')

let informationList = document.getElementById("workinfoodmenu");
...
btn.forEach(function(button) {
    button.addEventListener("click", function() {
      ...
      var informationList = document.getElementById("workinfoodmenu");
